...
if (+ function(a) {
        ...
        a.supr = function(b, d) {
            ...
            f.init = function() {
                ...
                //    e = d.closest(".sub");
                //b.empty(),
                ////b.append("<li>You are here:</li>"),
                //b.append('<li><a href="#" class="tip" title="back to dashboard">' + c + "</a></li>"),
                //b.append('<span class="divider"><i class="' + f.settings.breadcrumbs.dividerIcon + '"></i></span>'),
                //e.closest("li").hasClass("hasSub") ? (navel1 = e.prev("a.active-state"), link = navel1.attr("href"),
                //text1 = navel1.children(".notification").remove().end().text().trim(), b.append('<li><a href="' + link + '">' + text1 + "</a></li>"),
                //text = d.children(".notification").remove().end().text(),
                //b.append('<span class="divider"><i class="' + f.settings.breadcrumbs.dividerIcon + '"></i></span>'),
                //b.append("<li>" + text + "</li>")) : (text = d.children(".notification").remove().end().text(), b.append("<li>" + text + "</li>"))
